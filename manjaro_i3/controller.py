...
class FileManaging:
    @staticmethod
    def importYaml(directory, fileName):
...
class Preqrequisites:
    ...
    def installAndConfigureGit(configDirectory, gitConfigYaml):
        gitConfig = FileManaging.importYaml(configDirectory, gitConfigYaml)
...
class DriveMounting:
    ...
    @classmethod
    def mountDrives(cls, drivesDirectory, drivesYaml):
        drives = FileManaging.importYaml(drivesDirectory, drivesYaml)
...
class Packages:
    ...
    @classmethod
    def installPackages(cls, packagesDirectory, packagesYamlFile):
        packages = FileManaging.importYaml(packagesDirectory, packagesYamlFile)
        cls.addRepository()
